...
func main() {
	...
	if age, ok := stdAge["Siska"]; ok {
		fmt.Println("Siswa baru, Siska berumur:", age)
	} else {
		fmt.Println("Siska belum ada dalam data")
		stdAge["Siska"] = 19 // Tambahkan data Siska
	}
	// -- End of Part 2 --
